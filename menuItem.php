    ...
    <div class="container mt-3 top-bar px-5">
        <div class="dropdown">
            ...
            <div id="myDropdown1" class="dropdown-content">
                <h6 style="background-color: rgb(96, 245, 77);">Unoccupied</h6><hr>
                <?php
                ...
                ?>
                <h6 style="background-color: rgb(96, 245, 77);">Occupied</h6><hr>
                <?php
            ...
            <div class="menuItem" id="<?php echo $rows['item_no']; ?>">
                ...
                <div class="buttons">
                    <form action="orderPage.php" method="POST">
                        ...
                        <input class="btn btn-success btn-sm" type="submit" name="order" value="Order Item">
                    </form>
                </div>
